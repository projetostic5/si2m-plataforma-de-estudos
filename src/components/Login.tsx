  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signInError) {
        ...
        // O redirecionamento sera feito pelo App com base no role
      }
    } catch (err) {
        ...
        <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-6 pt-6 border-t border-slate-700/50">
            <p className="text-sm text-slate-400 text-center mb-4">
              Nao tem uma conta de estudante?
            </p>
            <Link
              to="/cadastro"
              className="w-full flex items-center justify-center gap-2 py-3 border border-emerald-500/30 text-emerald-400 rounded-xl font-medium hover:bg-emerald-500/10 transition-all"
            >
